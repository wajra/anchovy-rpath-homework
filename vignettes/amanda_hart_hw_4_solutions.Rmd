...
# Load packages
```{r}
pacman::p_load("tidyverse","Rpath","here")
```
# Try out Rsim
...
ggplot(fish_df, aes(x=fish_type, y=fish_value)) + geom_bar(stat="identity") + xlab("Total Revenue (USD per km-2yr-1) over 100 years") +
  ylab("Species")
dev.off()
